...
import com.expertsoft.training.service.impl.DefaultBandsService;
...
public class DefaultBandsServiceIntegrationTest extends ServicelayerBaseTest
{
	...
	{
		// given
		final String logoCode = "bandsPlatformLogo";

		// when
		final String logoUrl = bandsService.getHybrisLogoUrl(logoCode);
