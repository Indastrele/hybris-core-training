...
@SystemSetup(extension = "concerts")
public class ConcertsCustomSetup {

    private static final Logger LOG = LoggerFactory.getLogger(ConcertsCustomSetup.class);
    ...
    public boolean putInMyEssentialData() {
        LOG.info("Starting custom essential data loading for the Concerts extension");
        LOG.info("Custom essential data loading for the Concerts extension completed.");
        return true;
    }

    @SystemSetup(type = SystemSetup.Type.PROJECT)
    public boolean addMyProjectData() {
        LOG.info("Starting custom project data loading for the Concerts extension");
        impexImport("/impex/concerts.impex");
        LOG.info("Custom project data loading for the Concerts extension completed.");
        return true;
    }

    protected boolean impexImport(final String filename) {
        final String message = "Concerts impexing [" + filename + "]...";
