...
public class DefaultConcertsService implements ConcertsService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultConcertsService.class);
	...
	{
		return DefaultConcertsService.class.getResourceAsStream("/concerts/sap-hybris-platform.png");
	}
